...
The bar chart shows us that those who took the placebo got sick more than the males who took the Covid91. We can see that the pink bar for placebo is almost double in size compared to the vaccine. This indicates the vaccine is effective for the Males group.
...
According to the Percent bar chart, the Drug Users group does benefit from taking this drug. In our sick group, more than 60% had not taken the vaccine, giving us some insight into its efficacy.
...
33% of the sick Drug Users had the treatment, and 67% of the Drug Users who got sick took the placebo. This is a 2 to 1 difference and lets us know that the vaccine is in fact working.
...
Since our p-value is small(0.002) this indicates that we need to reject the null hypothesis and that there is a difference between the Drug Users who took the placebo and the Drug Users who took the drug. In this case, it looks like the data is different as in the drug is effective compared to the placebo.
...
The effectiveness of the Covid91 vaccine for LGBTQ community is `r LGBTQEffect`. The confidence interval for those in the LGBTQ community is `r LGBTQloweffect` to `r LGBTQhigheffect` . 
...
The results were that this experimental COVID91 vaccine worked on people in Males group and the Drug Users group. This vaccine was not effective for those in the Females group and the LGBTQ+, with more people getting sick if they took the vaccine versus the placebo. These results were confirmed via the p-test and efficacy results, with a confidence interval of
